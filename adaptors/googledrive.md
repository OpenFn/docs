...
- **access_token**: OAuth 2.0 access token obtained through Google's
  authentication flow

Access tokens can be generated through Google Cloud Console and provide scoped
access to Google Drive resources based on the permissions granted during the
OAuth flow.
