      ...
      <details>
        ...
        {publicPaths.find(p => p.name == a.module) ? (
          <div>
            ...
            for <b>{a.module}</b> are available here. You can view the source &
...
See the
[Github Adaptors wiki](https://github.com/OpenFn/adaptors/blob/main/wiki/index.md)
for the technical guide to developing adaptors.
