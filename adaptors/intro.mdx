...
<!-- https://github.com/OpenFn/docs/issues/403 -->
<!-- See the
[FAQs](/documentation/faqs#can-openfn-integrate-with-my-custom-app) and
[Generic Data Sources](/documentation/source-apps) for more info on how to
connect to systems without custom adaptors. -->
...
[Inspector](/documentation/build/steps/step-editor), but you are guaranteed that the
