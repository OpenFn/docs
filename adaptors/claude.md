...
## Using other Claude-compatible LLM providers

This adaptor can be configured to use any LLM provider endpoint that implements
the Claude Messages API specification. With this, responses can be generated by
...
- to use a specific provider - for example, routing through a regional service,
