...
this is your first go, this page can help you think through
...
[(or borrowing)](https://docs.openfn.org/library) a [job](https://docs.openfn.org/documentation/jobs/job-design-intro/).
...
These are all very important questions to consider when designing an integration. 
Check out our docs on integration design to learn more about how we begin to answer these questions and more:
