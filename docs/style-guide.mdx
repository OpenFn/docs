...
To add Gifs to OpenFn documentation download this chrome extension:
[Chrome Capture Extension](https://chrome.google.com/webstore/detail/chrome-capture-screenshot/ggaabchcecdbomdcnbahdfddfikjmphe 'Chrome Capture')

Please note that "Chrome Capture" has a one time fee of $5.99 for the premium
features that are required to make helpful Gifs. These premium features include
unlimited recording time and the ability to change editing color and font.

Once you have downloaded "Chrome Capture" enable the following **Free** and
**Premium Settings**: 
:::important

Please note that the hex # for the color of the "cursor dot" and the "show click
animation" is **#B53F48**.

::: 
![Chrome Capture Settings](/img/chrome_capture_gif.png)
