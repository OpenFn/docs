...
Note that the `state` object returned at the end of each step in a workflow must
not exceed 25% of your total runtime memory limit or your run will be killed
with a `StateTooLarge` error.
