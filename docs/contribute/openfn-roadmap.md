...
| • OpenFn Workflow JSON APIs                        | In dev     | Q4 '24       | [Issue 2126](https://github.com/OpenFn/Lightning/issues/2126)                                                                   | Expose API endpoints that allows developers to interact with OpenFn from other platforms or within jobs. e.g create a new workflow with the jobs given a JSON payload.       |
| • Productionize data collections                   | Delivered  | Q4 '24       | [Issue 2815](https://github.com/OpenFn/lightning/issues/2815)                                                                   | Make data collections more accessible to users by allowing project owners and admins to create and manage data collections in their projects.                                |
