...
| :-----------------------------------------------------: | :----------------------------------------------------- | :--------: | :----------: | :----------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [2126](https://github.com/OpenFn/Lightning/issues/2126) | OpenFn Workflow JSON APIs                              | Delivered  |    Q1'25     |              | Expose API endpoints that allows developers to interact with OpenFn from other platforms or within jobs. e.g create a new workflow with the jobs given a JSON payload.                                                                      |
| [2815](https://github.com/OpenFn/lightning/issues/2815) | Data Collections (all users)                           | Delivered  |    Q1'25     |              | Make data collections accessible to users by allowing project owners and admins to create and manage data collections in their projects. (See [feature request](https://community.openfn.org/t/allow-all-users-to-create-collections/746).) |
| [2155](https://github.com/OpenFn/lightning/issues/905)  | Locally-Served Adaptors                                | Delivered  |    Q1'25     |              | Enable lightning to use local adaptors to allow developers quickly test adaptors locally without deploying to npm                                                                                                                           |
| [2920](https://github.com/OpenFn/lightning/issues/2920) | Filter work orders by run state                        |   Shaped   |    Q1'25     |   ✨ (new)   | Allow users to filter project work orders by run state via the history page.ß                                                                                                                                                               |
...
| [1755](https://github.com/OpenFn/Lightning/issues/1755) | Control Log Levels and Outputs                         |   Shaped   |    Q1'25     |              | Control what is printed in run logs by specifying log levels and allow users to disable printing console.logs, for data privacy once workflows are handling production data.                                                                |
...
| :--------------------------------------------------: | :------------------ | :--------: | :----------: | :------: | -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [827](https://github.com/OpenFn/adaptors/issues/827) | Intuit (Quickbooks) | Delivered  |    Q1'25     | ✨ (new) | Intuit Quickbooks adaptor to enable users to fetch, create and update invoices.                                                                          |
|  [870](https://github.com/OpenFn/adaptors/pull/870)  | Gmail               | Delivered  |    Q1'25     | ✨ (new) | Gmail adaptor for users to read, search and send emails via an authenticated Gmail account.                                                              |
|  [912](https://github.com/OpenFn/adaptors/pull/912)  | Hubtel              | Delivered  |    Q1'25     | ✨ (new) | Allow users to be automate SMS workflows in Ghana via Hubtel.                                                                                            |
|  [912](https://github.com/OpenFn/adaptors/pull/912)  | Wigal               | Delivered  |    Q1'25     | ✨ (new) | Allow users to be automate SMS workflows in Ghana via Wigal.                                                                                             |
