...
| **Run** _(alternate action)_ | IDE             | `⌘+Shift+Return` | `Ctrl+Shift+Enter` | This will save (but not sync) your workflow and create a new workorder from the current step.                                |
| **Open** IDE (code editor)   | Canvas          | `⌘+e`            | `Ctrl+e`           | Opens the full-screen code editor for the selected job.                                                                      |
