...
| **Run**                       | Canvas, IDE     | `⌘+Return`       | `Ctrl+Enter`       | This will save your workflow and run it from the current step with the default workorder grouping behavior.\*                |
| **Run** _(alternate action)_  | Canvas, IDE     | `⌘+Shift+Return` | `Ctrl+Shift+Enter` | This will save your workflow and open the custom run input dialog or (if open) create a new workorder from the current step. |
