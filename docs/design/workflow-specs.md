...
example diagram below, you might implement 1 job with 3 chained operations, or 3
jobs with 1 operation each.

![workflow](/img/workflow_specs.webp)

**The workflow specifications should link to all of the design artifacts and
